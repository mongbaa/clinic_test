                                        ...
                                        ?>
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="count<?php echo $x; ?>" class="form-control rounded-pill" placeholder="วันที่ประเมินการสอบ" value="<?php echo $edit_count[$x]; ?>">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="last_date<?php echo $x; ?>" class="form-control rounded-pill" placeholder="วันที่ประเมินการสอบ" value="<?php echo $edit_last_date[$x]; ?>">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="time_start<?php echo $x; ?>" class="form-control rounded-pill" placeholder="วันที่ประเมินการสอบ" value="<?php echo $edit_time_start[$x]; ?>">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="time_end<?php echo $x; ?>" class="form-control rounded-pill" placeholder="วันที่ประเมินการสอบ" value="<?php echo $edit_time_end[$x]; ?>">
                                            ...
                                            <div class="col-sm-1">
                                                <div class="form-group">
                                                    <?php
                                                    if (!empty($edit_time_start[$x])) {
                                                        $edit_time_start = $edit_time_start[$x];
                                                    } else {
                                                        $edit_time_start = "00:00";
                                                    }

                                                    if (!empty($edit_time_end[$x])) {
                                                        $edit_time_end = $edit_time_end[$x];
                                                    } else {
                                                        $edit_time_end = "00:00";
                                                    }
